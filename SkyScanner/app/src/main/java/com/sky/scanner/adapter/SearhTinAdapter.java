...
public class SearhTinAdapter extends RecyclerView.Adapter<SearhTinAdapter.MovieViewHolder> {
    ...
    public SearhTinAdapter(List<SearchTinResponseModel> data, int rowLayout, Context context) {
        this.data = data;
